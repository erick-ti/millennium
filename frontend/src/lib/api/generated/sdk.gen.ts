 ...
 */
export const alertsEventsList = <ThrowOnError extends boolean = false>(options?: Options<AlertsEventsListData, ThrowOnError>): RequestResult<AlertsEventsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<AlertsEventsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const alertsRulesList = <ThrowOnError extends boolean = false>(options?: Options<AlertsRulesListData, ThrowOnError>): RequestResult<AlertsRulesListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<AlertsRulesListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * injects ``X-CSRFToken``). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const alertsRulesCreate = <ThrowOnError extends boolean = false>(options: Options<AlertsRulesCreateData, ThrowOnError>): RequestResult<AlertsRulesCreateResponses, AlertsRulesCreateErrors, ThrowOnError> => (options.client ?? client).post<AlertsRulesCreateResponses, AlertsRulesCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const auditClientErrorsCreate = <ThrowOnError extends boolean = false>(options: Options<AuditClientErrorsCreateData, ThrowOnError>): RequestResult<AuditClientErrorsCreateResponses, AuditClientErrorsCreateErrors, ThrowOnError> => (options.client ?? client).post<AuditClientErrorsCreateResponses, AuditClientErrorsCreateErrors, ThrowOnError>({
 ...
 */
export const auditErrorGroupsList = <ThrowOnError extends boolean = false>(options?: Options<AuditErrorGroupsListData, ThrowOnError>): RequestResult<AuditErrorGroupsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<AuditErrorGroupsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const auditEventsList = <ThrowOnError extends boolean = false>(options?: Options<AuditEventsListData, ThrowOnError>): RequestResult<AuditEventsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<AuditEventsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * list-only guard from the read-API convention, so a stray param can't 404 a retrieve.
 */
export const auditEventsRetrieve = <ThrowOnError extends boolean = false>(options: Options<AuditEventsRetrieveData, ThrowOnError>): RequestResult<AuditEventsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<AuditEventsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const authDemoLoginCreate = <ThrowOnError extends boolean = false>(options?: Options<AuthDemoLoginCreateData, ThrowOnError>): RequestResult<AuthDemoLoginCreateResponses, AuthDemoLoginCreateErrors, ThrowOnError> => (options?.client ?? client).post<AuthDemoLoginCreateResponses, AuthDemoLoginCreateErrors, ThrowOnError>({ url: '/api/auth/demo-login/', ...options });
 ...
 */
export const cardsCardsList = <ThrowOnError extends boolean = false>(options?: Options<CardsCardsListData, ThrowOnError>): RequestResult<CardsCardsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CardsCardsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * has at most a handful) so the card-detail view loads in one round-trip.
 */
export const cardsCardsRetrieve = <ThrowOnError extends boolean = false>(options: Options<CardsCardsRetrieveData, ThrowOnError>): RequestResult<CardsCardsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<CardsCardsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const cardsCardsArchetypesRetrieve = <ThrowOnError extends boolean = false>(options?: Options<CardsCardsArchetypesRetrieveData, ThrowOnError>): RequestResult<CardsCardsArchetypesRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CardsCardsArchetypesRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const cardsPrintingsList = <ThrowOnError extends boolean = false>(options?: Options<CardsPrintingsListData, ThrowOnError>): RequestResult<CardsPrintingsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CardsPrintingsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * global ``PageNumberPagination(PAGE_SIZE=100)`` paginates the ~14k-row catalog.
 */
export const cardsPrintingsRetrieve = <ThrowOnError extends boolean = false>(options: Options<CardsPrintingsRetrieveData, ThrowOnError>): RequestResult<CardsPrintingsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<CardsPrintingsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const collectionItemsList = <ThrowOnError extends boolean = false>(options?: Options<CollectionItemsListData, ThrowOnError>): RequestResult<CollectionItemsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CollectionItemsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * ``printing`` FKs and the storage location are pre-joined for the list shape.
 */
export const collectionItemsRetrieve = <ThrowOnError extends boolean = false>(options: Options<CollectionItemsRetrieveData, ThrowOnError>): RequestResult<CollectionItemsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<CollectionItemsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const collectionLotsList = <ThrowOnError extends boolean = false>(options?: Options<CollectionLotsListData, ThrowOnError>): RequestResult<CollectionLotsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CollectionLotsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * holding, with unknown-date lots last.
 */
export const collectionLotsRetrieve = <ThrowOnError extends boolean = false>(options: Options<CollectionLotsRetrieveData, ThrowOnError>): RequestResult<CollectionLotsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<CollectionLotsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const csrfRetrieve = <ThrowOnError extends boolean = false>(options?: Options<CsrfRetrieveData, ThrowOnError>): RequestResult<CsrfRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<CsrfRetrieveResponses, unknown, ThrowOnError>({ url: '/api/csrf/', ...options });
 ...
 */
export const decksDecksList = <ThrowOnError extends boolean = false>(options?: Options<DecksDecksListData, ThrowOnError>): RequestResult<DecksDecksListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<DecksDecksListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * shape). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksDecksCreate = <ThrowOnError extends boolean = false>(options: Options<DecksDecksCreateData, ThrowOnError>): RequestResult<DecksDecksCreateResponses, DecksDecksCreateErrors, ThrowOnError> => (options.client ?? client).post<DecksDecksCreateResponses, DecksDecksCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * shape). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksDecksDestroy = <ThrowOnError extends boolean = false>(options: Options<DecksDecksDestroyData, ThrowOnError>): RequestResult<DecksDecksDestroyResponses, unknown, ThrowOnError> => (options.client ?? client).delete<DecksDecksDestroyResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * shape). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksDecksRetrieve = <ThrowOnError extends boolean = false>(options: Options<DecksDecksRetrieveData, ThrowOnError>): RequestResult<DecksDecksRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<DecksDecksRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * shape). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksDecksPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<DecksDecksPartialUpdateData, ThrowOnError>): RequestResult<DecksDecksPartialUpdateResponses, unknown, ThrowOnError> => (options.client ?? client).patch<DecksDecksPartialUpdateResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * shape). Inherits ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksDecksUpdate = <ThrowOnError extends boolean = false>(options: Options<DecksDecksUpdateData, ThrowOnError>): RequestResult<DecksDecksUpdateResponses, unknown, ThrowOnError> => (options.client ?? client).put<DecksDecksUpdateResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const decksMembershipsList = <ThrowOnError extends boolean = false>(options?: Options<DecksMembershipsListData, ThrowOnError>): RequestResult<DecksMembershipsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<DecksMembershipsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksMembershipsCreate = <ThrowOnError extends boolean = false>(options: Options<DecksMembershipsCreateData, ThrowOnError>): RequestResult<DecksMembershipsCreateResponses, DecksMembershipsCreateErrors, ThrowOnError> => (options.client ?? client).post<DecksMembershipsCreateResponses, DecksMembershipsCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * ``IsAuthenticated`` + ``PageNumberPagination``.
 */
export const decksMembershipsDestroy = <ThrowOnError extends boolean = false>(options: Options<DecksMembershipsDestroyData, ThrowOnError>): RequestResult<DecksMembershipsDestroyResponses, unknown, ThrowOnError> => (options.client ?? client).delete<DecksMembershipsDestroyResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const healthRetrieve = <ThrowOnError extends boolean = false>(options?: Options<HealthRetrieveData, ThrowOnError>): RequestResult<HealthRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<HealthRetrieveResponses, unknown, ThrowOnError>({ url: '/api/health/', ...options });
 ...
 */
export const importsBatchesList = <ThrowOnError extends boolean = false>(options?: Options<ImportsBatchesListData, ThrowOnError>): RequestResult<ImportsBatchesListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ImportsBatchesListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const importsBatchesCreate = <ThrowOnError extends boolean = false>(options: Options<ImportsBatchesCreateData, ThrowOnError>): RequestResult<ImportsBatchesCreateResponses, ImportsBatchesCreateErrors, ThrowOnError> => (options.client ?? client).post<ImportsBatchesCreateResponses, ImportsBatchesCreateErrors, ThrowOnError>({
 ...
 * ``create`` makes the router bind POST on the collection route (no separate mixin needed).
 */
export const importsBatchesRetrieve = <ThrowOnError extends boolean = false>(options: Options<ImportsBatchesRetrieveData, ThrowOnError>): RequestResult<ImportsBatchesRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<ImportsBatchesRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const importsRowsList = <ThrowOnError extends boolean = false>(options?: Options<ImportsRowsListData, ThrowOnError>): RequestResult<ImportsRowsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ImportsRowsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * a human-chosen printing, ``reject`` skips it.
 */
export const importsRowsRetrieve = <ThrowOnError extends boolean = false>(options: Options<ImportsRowsRetrieveData, ThrowOnError>): RequestResult<ImportsRowsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<ImportsRowsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const importsRowsApproveCreate = <ThrowOnError extends boolean = false>(options: Options<ImportsRowsApproveCreateData, ThrowOnError>): RequestResult<ImportsRowsApproveCreateResponses, ImportsRowsApproveCreateErrors, ThrowOnError> => (options.client ?? client).post<ImportsRowsApproveCreateResponses, ImportsRowsApproveCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const importsRowsOverrideCreate = <ThrowOnError extends boolean = false>(options: Options<ImportsRowsOverrideCreateData, ThrowOnError>): RequestResult<ImportsRowsOverrideCreateResponses, ImportsRowsOverrideCreateErrors, ThrowOnError> => (options.client ?? client).post<ImportsRowsOverrideCreateResponses, ImportsRowsOverrideCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const importsRowsRejectCreate = <ThrowOnError extends boolean = false>(options: Options<ImportsRowsRejectCreateData, ThrowOnError>): RequestResult<ImportsRowsRejectCreateResponses, ImportsRowsRejectCreateErrors, ThrowOnError> => (options.client ?? client).post<ImportsRowsRejectCreateResponses, ImportsRowsRejectCreateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * valuation beat).
 */
export const portfolioPortfoliosList = <ThrowOnError extends boolean = false>(options?: Options<PortfolioPortfoliosListData, ThrowOnError>): RequestResult<PortfolioPortfoliosListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<PortfolioPortfoliosListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * valuation beat).
 */
export const portfolioPortfoliosRetrieve = <ThrowOnError extends boolean = false>(options: Options<PortfolioPortfoliosRetrieveData, ThrowOnError>): RequestResult<PortfolioPortfoliosRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<PortfolioPortfoliosRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const portfolioSnapshotsList = <ThrowOnError extends boolean = false>(options?: Options<PortfolioSnapshotsListData, ThrowOnError>): RequestResult<PortfolioSnapshotsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<PortfolioSnapshotsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * consumers handle NULL distinctly from 0.
 */
export const portfolioSnapshotsRetrieve = <ThrowOnError extends boolean = false>(options: Options<PortfolioSnapshotsRetrieveData, ThrowOnError>): RequestResult<PortfolioSnapshotsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<PortfolioSnapshotsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const pricingSnapshotsList = <ThrowOnError extends boolean = false>(options?: Options<PricingSnapshotsListData, ThrowOnError>): RequestResult<PricingSnapshotsListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<PricingSnapshotsListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 * can't accidentally page into history when it only wants today.
 */
export const pricingSnapshotsRetrieve = <ThrowOnError extends boolean = false>(options: Options<PricingSnapshotsRetrieveData, ThrowOnError>): RequestResult<PricingSnapshotsRetrieveResponses, unknown, ThrowOnError> => (options.client ?? client).get<PricingSnapshotsRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const pricingSnapshotsLatestRetrieve = <ThrowOnError extends boolean = false>(options: Options<PricingSnapshotsLatestRetrieveData, ThrowOnError>): RequestResult<PricingSnapshotsLatestRetrieveResponses, PricingSnapshotsLatestRetrieveErrors, ThrowOnError> => (options.client ?? client).get<PricingSnapshotsLatestRetrieveResponses, PricingSnapshotsLatestRetrieveErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const statusChecksRetrieve = <ThrowOnError extends boolean = false>(options?: Options<StatusChecksRetrieveData, ThrowOnError>): RequestResult<StatusChecksRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<StatusChecksRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const statusInfraRetrieve = <ThrowOnError extends boolean = false>(options?: Options<StatusInfraRetrieveData, ThrowOnError>): RequestResult<StatusInfraRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<StatusInfraRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const statusOverviewRetrieve = <ThrowOnError extends boolean = false>(options?: Options<StatusOverviewRetrieveData, ThrowOnError>): RequestResult<StatusOverviewRetrieveResponses, unknown, ThrowOnError> => (options?.client ?? client).get<StatusOverviewRetrieveResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
 ...
 */
export const valuationMoversList = <ThrowOnError extends boolean = false>(options?: Options<ValuationMoversListData, ThrowOnError>): RequestResult<ValuationMoversListResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ValuationMoversListResponses, unknown, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'sessionid',
            type: 'apiKey'
