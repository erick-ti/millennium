...
// An anonymous 403 now redirects to /login globally, so this
...
interface QueryErrorStateProps {
   ...
   * would otherwise strand the user on a dead-end card.
 ...
 * Retry and an optional paged-escape button. Extracted from the original
